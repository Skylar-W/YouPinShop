  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <!-- 商品品牌 -->
        <ul class="logo-list">
          <li v-for="(trademark, index) in tradeList" :key="trademark.tmId" @click="tradeMarkHandler(trademark)">{{ trademark.tmName }}</li>
        </ul>
      </div>
      <div class="ext">
...
<script>
  ...
  export default {
    name: 'SearchSelector',
    computed: {
      ...mapGetters(['tradeList', 'attrsList'])
    },
    methods: {
      tradeMarkHandler(trademark) {
        //searchParams在父组件里,请求从父组件里发,然后父子组件之间用自定义事件通信
