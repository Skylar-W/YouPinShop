  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ receiveInfo.fullAddress }}</span>
        收货人：<span>{{ receiveInfo.consignee }}</span>
        <span>{{ receiveInfo.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async submitTrade() {//提交订单
      let { tradeNo } = this.tradeInfo;
      let data = {
        consignee: this.receiveInfo.consignee,
        consigneeTel: this.receiveInfo.phoneNum,
        deliveryAddress: this.receiveInfo.fullAddress,
        paymentWay: "ONLINE",
